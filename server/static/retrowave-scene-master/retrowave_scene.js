...
const MOUSE_MOVEMENT_MULTIPLIER = .2;
const HARDCODED_PATH = "/static/retrowave-scene-master/";
...
export var RetrowaveScene = function (scenePath) {
  ...
  this.svgFiles = [
    [`./${this.scenePath}${HARDCODED_PATH}scenery/sun.svg`, 0, 40, -500, 0.11, "sun"],
    [`./${this.scenePath}${HARDCODED_PATH}scenery/city_far.svg`, 0, 15, -450, 0.4, "cityFar"],
    [`./${this.scenePath}${HARDCODED_PATH}scenery/city_close.svg`, 0, 28, -300, 0.2, "cityClose"],
  ];
  // ... and specify your skybox textures here
  this.skybox = [
    `./${this.scenePath}${HARDCODED_PATH}skybox/${this.textureResolution}/px.png`, // X+
    `./${this.scenePath}${HARDCODED_PATH}skybox/${this.textureResolution}/nx.png`, // X-
    `./${this.scenePath}${HARDCODED_PATH}skybox/${this.textureResolution}/py.png`, // Y+
    `./${this.scenePath}${HARDCODED_PATH}skybox/${this.textureResolution}/invisible.png`, // Y- (out of camera FoV here)
    `./${this.scenePath}${HARDCODED_PATH}skybox/${this.textureResolution}/invisible.png`, // Z+ (out of camera FoV here)
    `./${this.scenePath}${HARDCODED_PATH}skybox/${this.textureResolution}/nz.png`, // Z-
  ];
...
RetrowaveScene.prototype.animate = function () {
  ...
  // Those values allow to limit camera (more a workaround than a proper solution)
  this.target.x = (1 - this.mouse.x) * 0.00065 * MOUSE_MOVEMENT_MULTIPLIER;
  this.target.y = (1 - this.mouse.y) * 0.0003 * MOUSE_MOVEMENT_MULTIPLIER;
